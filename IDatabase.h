...
{
public:
    virtual Row Query( const char*, ... ) = 0;
    virtual RowList MultiQuery( const char*, ... ) = 0;

protected:
    virtual bool OpenDatabase( const std::string& ) = 0;
    virtual bool CloseDatabase( const std::string& ) = 0;
};